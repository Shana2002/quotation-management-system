...
INSERT INTO `plans` (`id`, `name`, `plan_type`, `description`, `amount`, `parameters`, `benefits`, `summary_template`, `terms_template`, `status`) VALUES
    (1, 'Royal Plus', 'royal_plus',
        'Interest/harvest-income plan, 1–5 year tenure, monthly or annual payout.', 0.00,
        '{"years":{"1":{"monthly_rate":2,"annual_rate":24},"2":{"monthly_rate":2,"annual_rate":24},"3":{"monthly_rate":2,"annual_rate":24},"4":{"monthly_rate":2,"annual_rate":24},"5":{"monthly_rate":2,"annual_rate":24}}}',
